...
var randomOutsideNorthBeach = function(){
  var restaurantArray = [];
  restuarantArray = [14,15,16];
  return restuarantArray[Math.floor(Math.random() * restuarantArray.length)];
}

var randomInsideNorthBeach = function(){
  var restaurantArray = [];
  restuarantArray = [6,7,8,9,10,11,12,13];
  return restuarantArray[Math.floor(Math.random() * restuarantArray.length)];
}

var randomItalian = function(){
  var restuarantArray = [6,8,9,13];
  return restuarantArray[Math.floor(Math.random() * restuarantArray.length)];
}

// Questions
var nodes = [{ "node": 1, "message": "Do you want to eat in North Beach", "yes": 2, "no": randomOutsideNorthBeach() },
             { "node": 2, "message": "Do you want only Italian food", "yes": randomItalian(), "no": 3 },
             { "node": 3, "message": "Do you want only Mexican food", "yes": 7, "no": 4 },
             { "node": 4, "message": "Do you want only Asian food", "yes": 11, "no": 5 },
             { "node": 5, "message": "Are you up for anything", "yes": randomInsideNorthBeach(), "no": 11 },

// Answers & descriptions
             { "node": 6, "message": "Italian Homemade Company", "yes": 0, "no": 0, "description": "On Columbus Ave. This place has fresh pasta and sauces" },
             { "node": 7, "message": "Don Pisto’s", "yes": 0, "no": 0, "description": "On Union St. This is Mexican food with bumpin jams and fun atmosphere"},
             { "node": 8, "message": "Piccolo Forno", "yes": 0, "no": 0 , "description": "On Columbus Ave. This is a small Italian restuarant with good pizzas and pastas."},
             { "node": 9, "message": "Sotto Mare", "yes": 0, "no": 0 , "description": "On Green St. This is an Italian sea food restaurant."},
             { "node": 10, "message": "Buster’s Cheesesteak", "yes": 0, "no": 0 , "description": "On Columbus Ave. This is a heart stopper of a sandwich. If you survive it, it's worth it."},
             { "node": 11, "message": "Chubby Noodle", "yes": 0, "no": 0 , "description": "On Grant st. This is an Asian fusion retaurant with great Sake and an upbeat atmosphere"},
             { "node": 12, "message": "Sam's", "yes": 0, "no": 0 , "description": "On Broadway. Look no further for your whole in the wall, best greese in your gut, burger. "},
             { "node": 13, "message": "Il Pollaio", "yes": 0, "no": 0 , "description": "On Columbus Avenue. Why did the chicken cross the road? To end up deliciously on your plate at Il Pollaio."},
             //outside of north beach
             { "node": 14, "message": "Tacorea", "yes": 0, "no": 0 , "description": "Next to Dragon Gate. Korean Mexican fusion. This is basically Kogi on a brick and morter building."},
             { "node": 15, "message": "Hot Sauce and Panko", "yes": 0, "no": 0 , "description": "On Nob Hill. Top of the line hot wings."},
             { "node": 16, "message": "H. R. D.", "yes": 0, "no": 0 , "description": "Near Cal Train. Asian Mexican fusion."},
...
var welcomeMessage = "Are you hungry?";

// This is the message that is repeated if the response to the initial welcome message is not heard
var repeatWelcomeMessage = "Say yes to find a different place to eat or no to quit.";
...
var playAgainMessage = "Say 'tell me more' to hear a short description for this restaurant, or do you want to find something different?";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will identify where you want to eat. Want to start now?";

// This is the goodbye message when the user has asked to quit the game
var goodbyeMessage = "Ok, see you when you're hungry!";
